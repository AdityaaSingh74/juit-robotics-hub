        ...
        <div className="grid md:grid-cols-2 gap-12 mb-16">
          ...
          >
            <p className="text-lg text-foreground/90 leading-relaxed">
              The Drobotics Lab is a cutting-edge research facility dedicated to advancing robotics technology. Our lab focuses on autonomous systems, human-robot interaction, and industrial automation, providing students with hands-on experience in the latest robotics innovations.
            </p>
            <p className="text-lg text-foreground/90 leading-relaxed">
